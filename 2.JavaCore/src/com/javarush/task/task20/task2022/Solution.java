...
//
//        ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream(solution.stream.getFD()));
//        Solution solution1 = (Solution) solution.readObject(inputStream);
